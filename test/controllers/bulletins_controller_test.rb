...
class BulletinsControllerTest < ActionController::TestCase
  ...
  test "should create bulletin" do
    assert_difference('Bulletin.count') do
      post :create, bulletin: { description: @bulletin.description, list_id: @bulletin.list_id, title: @bulletin.title }
    end
  ...
  test "should update bulletin" do
    patch :update, id: @bulletin, bulletin: { description: @bulletin.description, list_id: @bulletin.list_id, title: @bulletin.title }
    assert_redirected_to bulletin_path(assigns(:bulletin))
  end
